...
| `02_complexity_measure_upper_bounds` | 028–045 | Restriction/junta/sign-rank invariances and upper bounds from classical complexity measures: DNF/CNF (width, volume, literal expansion, monotone), certificate covers, PTF sparsity, decision trees, Fourier support. |
...
| `05_positive_statistic_gates_and_grids` | 127–176 | The current frontier: one-bit gates over a positive statistic, multi-raw-slice and shared-statistic sandwiches, raw-mask gates, positive grids, Hamming-layer and multigrid profile bounds. |
