...
Consequently, if a degree-$w$ span certificate with $H$ heads is available in the sense of [24_threshold_degree_span_schema.md](24_threshold_degree_span_schema.md), then every width-$w$ DNF or CNF function satisfies
...
This is exactly [24_threshold_degree_span_schema.md](24_threshold_degree_span_schema.md): if all degree-at-most-$w$ multilinear polynomials lie in an $H$-head denominator-cleared span, then every function with threshold degree at most $w$ has head complexity at most $H$.
