...
$$ H^{*}(f) \leq \sum_{a=1}^{s}2^{\lvert N_a\rvert}. $$
...
$$ H^{*}(1-f) \leq \min\left\lbrace \sum_{a=1}^{s}2^{\lvert P_a\rvert}, \sum_{a=1}^{s}2^{\lvert N_a\rvert} \right\rbrace. $$
