...
$$
\left\lVert
q-\sum_{S\in\mathcal{A}}\widehat q(S)\chi_S
\right\rVert_{\infty}
<1,
$$
...
nonconstant monomials before cancellations. By the polynomial-threshold sparsity upper bound [35_ptf_sparsity_upper_bound.md](35_ptf_sparsity_upper_bound.md),
...
H^{*}(f)
\leq
\sum_{S\in\mathcal{A}}\left(2^{\lvert S\rvert}-1\right),
$$
