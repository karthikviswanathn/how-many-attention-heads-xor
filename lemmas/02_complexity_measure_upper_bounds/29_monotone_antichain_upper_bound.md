...
Thus $f$ has a monotone DNF with $\lvert\mathcal{M}_1(f)\rvert$ nonempty terms. The monotone DNF upper bound from [23_monotone_dnf_upper_bound.md](23_monotone_dnf_upper_bound.md) gives
...
Thus $f$ has a monotone CNF with $\lvert\mathcal{M}_0(f)\rvert$ nonempty clauses. The monotone CNF upper bound from [23_monotone_dnf_upper_bound.md](23_monotone_dnf_upper_bound.md) gives
