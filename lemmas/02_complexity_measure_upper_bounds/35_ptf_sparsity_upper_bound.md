...
The denominator is positive on the cube, and all variable coefficients are strictly negative. By the denominator-orientation lemma [26_denominator_orientation.md](26_denominator_orientation.md), $\phi:=A/B$ is a one-head atom.
