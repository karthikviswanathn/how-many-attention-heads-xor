...
By the polynomial-threshold sparsity upper bound [35_ptf_sparsity_upper_bound.md](35_ptf_sparsity_upper_bound.md),
...
Global bit-flip invariance from [22_restrictions_and_sign_rank.md](22_restrictions_and_sign_rank.md) gives $H^{*}(f)=H^{*}(g)$, so
...
Complement invariance from [22_restrictions_and_sign_rank.md](22_restrictions_and_sign_rank.md) gives $H^{*}(f)=H^{*}(1-f)$, proving the CNF statement. $\blacksquare$
