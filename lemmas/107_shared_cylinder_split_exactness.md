...
By the definition of $\operatorname{sactc}(f)$ in [106_split_affine_cylinder_cost.md](106_split_affine_cylinder_cost.md), the same displayed certificate gives
...
Lemma [106_split_affine_cylinder_cost.md](106_split_affine_cylinder_cost.md) gives
...
If the right-hand side is at most $2$, then $\operatorname{sactc}(f)\leq2$. The low-cost exactness clause of [106_split_affine_cylinder_cost.md](106_split_affine_cylinder_cost.md) gives the displayed exact split. $\blacksquare$
