...
The proof of the endpoint affine-threshold vote theorem [80_endpoint_affine_threshold_vote_upper_bound.md](80_endpoint_affine_threshold_vote_upper_bound.md) constructs one-head atom approximations with arbitrarily small uniform error for each endpoint affine-threshold feature $T$.
...
The calibrated threshold-vote theorem [79_calibrated_threshold_vote_upper_bound.md](79_calibrated_threshold_vote_upper_bound.md) gives
