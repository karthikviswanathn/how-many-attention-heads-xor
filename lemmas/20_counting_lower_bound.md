...
and $B_h(x)>0$ on the cube. This is a slight relaxation of the exact atom form from [05_linear_fractional_normal_form.md](05_linear_fractional_normal_form.md), so counting this larger family can only increase the number of possible Boolean functions.
...
where the upper bound is the positive weighted-sum interpolation bound from [04_weighted_sum_upper_bound.md](04_weighted_sum_upper_bound.md).
