...
where $\rho(T_j)$ is the raw atom approximation cost from [87_raw_calibrated_vote_support_bound.md](87_raw_calibrated_vote_support_bound.md).
...
By the calibrated decision-list theorem [84_calibrated_decision_list_upper_bound.md](84_calibrated_decision_list_upper_bound.md), every decision list with tests $T_1,\ldots,T_L$ has a strict weighted-vote representation
...
The raw-calibrated vote support bound [87_raw_calibrated_vote_support_bound.md](87_raw_calibrated_vote_support_bound.md) applied to this strict vote gives
