...
Applying the positive-projection sign-change upper bound [07_positive_projection_sign_changes.md](07_positive_projection_sign_changes.md) to $s$ gives the stated head bound. $\blacksquare$
