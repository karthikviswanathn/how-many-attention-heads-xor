...
$$
W_Q \thickspace=\thickspace W_K \thickspace=\thickspace \begin{pmatrix} 1 & 0 \\ 0 & 0 \end{pmatrix}, \qquad W_V \thickspace=\thickspace \begin{pmatrix} 0 & 0 \\ 0 & 1 \end{pmatrix}, \qquad W_O \thickspace=\thickspace I_2.
$$
...
$$
z(k) \thickspace=\thickspace s(k)\thinspace v
$$

with

$$
s(k) \thickspace=\thickspace \frac{e\thinspace k}{e\thinspace k + (n-k) + e}.
$$
...
$$
s(k) \thickspace=\thickspace \frac{e\thinspace k}{(e-1)k + n + e}.
$$

For integer $0 \leq k < n$,

$$
s(k+1) - s(k) \thickspace=\thickspace \frac{e\thinspace(n+e)}{\bigl((e-1)k + n + e\bigr)\bigl((e-1)(k+1) + n + e\bigr)},
$$

which is strictly positive. Hence

$$
s(0) \thickspace<\thickspace s(1) \thickspace<\thickspace \cdots \thickspace<\thickspace s(n). \qquad \blacksquare
$$
