...
Then $A(x)/B(x)$ is a one-head atom in the sense of [05_linear_fractional_normal_form.md](05_linear_fractional_normal_form.md).
...
The lower bound $H^{*}(g) \geq 2$ was proved in [08_three_bit_projection_cases.md](08_three_bit_projection_cases.md), using the lattice-square obstruction and the one-head linear-threshold characterization. Therefore
...
2. `00011000` has $H^{*}=2$ by [08_three_bit_projection_cases.md](08_three_bit_projection_cases.md).
