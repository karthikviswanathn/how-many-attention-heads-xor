...
The proof is the four-bit analogue of [10_three_bit_exact_classification.md](10_three_bit_exact_classification.md), but here we only claim an upper bound.
