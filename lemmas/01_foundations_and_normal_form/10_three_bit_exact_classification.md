...
Each summand $A_i(x)/B_i(x)$ is a one-head atom by Lemma 1 of [09_three_bit_quadratic_upper_bound.md](09_three_bit_quadratic_upper_bound.md). Hence thresholding the sum of three atoms computes $f$, so
