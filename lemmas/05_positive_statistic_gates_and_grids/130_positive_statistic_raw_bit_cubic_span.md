...
on the Boolean cube. Since each $B_h$ has positive constant term and positive coefficients on every variable appearing in $t$ and on $z$, the affine-over-positive-affine atom lemma [09_three_bit_quadratic_upper_bound.md](../01_foundations_and_normal_form/09_three_bit_quadratic_upper_bound.md) makes every ratio $A_h/B_h$ a one-head atom.
