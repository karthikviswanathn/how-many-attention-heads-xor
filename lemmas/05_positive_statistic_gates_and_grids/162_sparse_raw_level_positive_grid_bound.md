...
The degree version follows from [160_positive_grid_degree_exactness.md](160_positive_grid_degree_exactness.md) after omitting constant levels, whose degree contribution is $0$. $\blacksquare$
