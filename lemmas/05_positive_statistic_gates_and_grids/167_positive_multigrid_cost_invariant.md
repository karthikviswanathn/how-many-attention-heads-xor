...
$$
t_j(x_{B_j})=\sum_{i\in B_j}\lambda_{j,i}x_i,
\qquad
\lambda_{j,i}>0,
$$
...
Fix a positive multigrid certificate and block order $\pi$. The positive lexicographic multigrid bound [164_positive_lexicographic_multigrid_bound.md](164_positive_lexicographic_multigrid_bound.md) gives
