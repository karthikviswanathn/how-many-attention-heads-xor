...
strictly sign-represents $z\oplus T(y)$. It has degree at most $C+1$ in the two quantities $t(y)$ and $z$, reduced using $z^2=z$. The positive-statistic raw-bit degree span [132_positive_statistic_raw_bit_degree_span.md](132_positive_statistic_raw_bit_degree_span.md) gives

$$
H^{*}(z\oplus T(y))\leq C+1.
$$

The lower bound is the fresh-bit XOR threshold-degree theorem [75_fresh_bit_xor_threshold_degree.md](../04_recursions_and_cost_invariants/75_fresh_bit_xor_threshold_degree.md):
