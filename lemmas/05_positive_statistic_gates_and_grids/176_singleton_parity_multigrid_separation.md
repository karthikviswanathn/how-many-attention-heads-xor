...
Finally, $\mathrm{XOR}_n$ is symmetric and its Hamming-weight truth table changes at every adjacent pair of weights. The exact symmetric sign-change theorem [06_symmetric_sign_changes.md](06_symmetric_sign_changes.md) gives
