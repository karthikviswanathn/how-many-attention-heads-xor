...
Assume first that $e_0=e_1=0$. Apply the raw-mask endpoint bound [148_raw_mask_gate_endpoint_bounds.md](148_raw_mask_gate_endpoint_bounds.md) to $R=M_a$. Since
