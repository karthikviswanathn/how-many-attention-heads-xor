...
As in [133_positive_statistic_fresh_xor_sign_change_bound.md](133_positive_statistic_fresh_xor_sign_change_bound.md), choose a strict degree-$C$ polynomial $Q$ such that
...
The lower bound for feature-dependent non-XOR gates is the one-bit gate threshold-degree trichotomy [76_one_bit_gate_threshold_degree_trichotomy.md](../04_recursions_and_cost_invariants/76_one_bit_gate_threshold_degree_trichotomy.md):
