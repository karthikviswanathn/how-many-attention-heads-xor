...
$$
H^{*}\bigl(F(r_1,\ldots,r_{j-1},\lvert x^{(j)}\rvert,r_{j+1},\ldots,r_b)\bigr)
\leq
H^{*}(f).
$$
...
Apply the positive lexicographic multigrid bound [164_positive_lexicographic_multigrid_bound.md](164_positive_lexicographic_multigrid_bound.md) with
