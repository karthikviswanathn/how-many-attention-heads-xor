...
Applying the ordered common positive-statistic slice bound [141_ordered_common_positive_statistic_slice_bound.md](141_ordered_common_positive_statistic_slice_bound.md) gives

$$
H^{*}\bigl(G(z,T(y))\bigr)
\leq
N_GC+B_{\rho}(g_{e_{\max}},g_{e_{\min}}).
$$
