...
Since $B_1$ and $B_2$ have positive constant terms and positive coefficients on every variable appearing in $t$ and on $z$, the affine-over-positive-affine atom lemma [09_three_bit_quadratic_upper_bound.md](../01_foundations_and_normal_form/09_three_bit_quadratic_upper_bound.md) makes
