...
The symmetric exactness theorem [06_symmetric_sign_changes.md](../01_foundations_and_normal_form/06_symmetric_sign_changes.md) gives

$$
\deg_{\pm}(T)=H^{*}(T)=C.
$$

The degree-tight positive-statistic gate classification [135_degree_tight_positive_statistic_gate_classification.md](135_degree_tight_positive_statistic_gate_classification.md) now applies and gives the displayed table. $\blacksquare$
