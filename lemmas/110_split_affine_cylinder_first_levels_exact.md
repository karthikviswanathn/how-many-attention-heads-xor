...
The split affine-cylinder cost theorem [106_split_affine_cylinder_cost.md](106_split_affine_cylinder_cost.md) gives

$$
\operatorname{actc}(f)\leq\operatorname{sactc}(f).
$$

If $\operatorname{sactc}(f)=0$, then $\operatorname{actc}(f)=0$, so $f$ is constant by [109_affine_cylinder_first_levels_exact.md](109_affine_cylinder_first_levels_exact.md).
...
By [109_affine_cylinder_first_levels_exact.md](109_affine_cylinder_first_levels_exact.md), $f$ is either constant or a nonconstant LTF. Since $\operatorname{sactc}(f)\neq0$, the first part rules out the constant case. Thus $f$ is a nonconstant LTF.
...
The first nontrivial split certificates are exactly the cost-$2$ certificates, and those are exact two-head certificates for non-LTFs by [106_split_affine_cylinder_cost.md](106_split_affine_cylinder_cost.md).
