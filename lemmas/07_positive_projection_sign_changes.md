...
is a one-head atom in the sense of [05_linear_fractional_normal_form.md](05_linear_fractional_normal_form.md).
...
2. For symmetric functions, taking $t(x)=\lvert x\rvert$ gives the exact sign-change count from [06_symmetric_sign_changes.md](06_symmetric_sign_changes.md).
