...
By the parity-block threshold-degree amplifier [083_parity_block_threshold_degree_amplifier.md](083_parity_block_threshold_degree_amplifier.md),
...
$$ \left(\bigoplus_{j=1}^{k}z_j\right) \oplus \mathrm{XOR}_{r}(y) $$
