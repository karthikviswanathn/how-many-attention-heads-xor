...
We use the notation of [97_affine_cylinder_threshold_cost.md](97_affine_cylinder_threshold_cost.md). A representation has score
...
on the free variables. As in the proof of [94_cylinder_threshold_cost_invariances.md](94_cylinder_threshold_cost_invariances.md),
