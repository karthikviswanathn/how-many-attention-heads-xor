...
The OR gate is neither XOR nor XNOR. Applying the one-bit non-XOR recursion theorem [81_one_bit_non_xor_gate_recursion.md](81_one_bit_non_xor_gate_recursion.md) gives
