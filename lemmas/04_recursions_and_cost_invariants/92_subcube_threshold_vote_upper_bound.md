...
For each $a$, the subcube raw calibration lemma [90_subcube_raw_calibration_cost.md](90_subcube_raw_calibration_cost.md) gives
...
Apply the raw-calibrated vote support bound [87_raw_calibrated_vote_support_bound.md](87_raw_calibrated_vote_support_bound.md) to the strict vote over the features $C_{P_a,N_a}$. It gives
