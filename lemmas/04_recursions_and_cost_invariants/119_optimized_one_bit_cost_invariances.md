...
We use the notation of [116_lifted_literal_gating_cost.md](116_lifted_literal_gating_cost.md) and [118_fresh_bit_xor_target_cost.md](118_fresh_bit_xor_target_cost.md). A strict affine-cylinder score for $T$ has the form
