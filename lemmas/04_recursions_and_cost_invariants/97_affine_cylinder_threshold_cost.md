...
For each $a\in\mathcal{J}$, the subcube raw calibration lemma [90_subcube_raw_calibration_cost.md](90_subcube_raw_calibration_cost.md) gives a constant $b_{a,0}$ and at most $\kappa(P_a,N_a)$ one-head atoms $\phi_{a,h}$ such that
