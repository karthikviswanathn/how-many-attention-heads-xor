...
q(z)P_{\leq d}(z)
&=
q(z)\bigl(q(z)-T_{>d}(z)\bigr) \\
&=
1-q(z)T_{>d}(z) \\
&\geq
1-\lVert T_{>d}\rVert_{\infty} \\
&>
0.
\end{aligned}
$$
...
Combined with [24_threshold_degree_span_schema.md](24_threshold_degree_span_schema.md), the criterion gives a concrete upper-bound pipeline:
