...
$$ H^{*}(f) \leq 1+\sum_{r=2}^{\min\lbrace d,v\rbrace}\binom{v}{r}, $$
...
$$ H^{*}(f) \leq \min\left\lbrace 2^{d+\lfloor d/2\rfloor-1}, 2^v-1, 1+\sum_{r=2}^{\min\lbrace d,v\rbrace}\binom{v}{r} \right\rbrace. $$
