...
lemmas close to `NHead`; this file gives the theorem layer a `Results.*` import.
-/

namespace HeadComplexity

/-- **Lemma 1.** The numerator, restricted to two coordinates, splits additively. -/
alias restricted_numerator_additive_split := NHead.numerator_additive_split

/-- **Lemma 2.** Antipode identity for the restricted numerator. -/
alias restricted_numerator_antipode := NHead.restricted_numerator_antipode
