...
- an optimized cylinder-threshold cost invariant upper-bounding $H^{*}$,
- structural invariances and restriction monotonicity for the cylinder-threshold cost,
- a subsumption theorem showing $\operatorname{ctc}$ recovers local certificate, formula, and decision-tree bounds,
- a comparison theorem placing $\operatorname{ctc}$ below polynomial-threshold sparsity,
- an affine-cylinder threshold cost invariant that allows one dense affine component,
- a hierarchy theorem placing the affine-cylinder cost below both $\operatorname{ctc}$ and affine-free sparsity,
- an explicit linear head lower-bound family from intersections of two halfspaces,
- a formal separation between $H^{*}$ and constant threshold-vote or LTF decision-list size,
...
- a threshold-degree sandwich for $\operatorname{actc}$ and the surrounding sparsity costs,
...
- a singleton parity separation showing multigrid cost can be much larger than $H^{*}$,
...
**Proof.** [lemmas/05_linear_fractional_normal_form.md](lemmas/05_linear_fractional_normal_form.md)
...
Let $f : \{0,1\}^n \to \{0,1\}$ be symmetric, so
...
and let $C(F)$ be the number of indices $t \in \{1,\ldots,n\}$ with
...
- monotone symmetric thresholds have $H^{*} = 1$,
- parity has $H^{*}(\mathrm{XOR}_n) = n$,
- internal exact-count predicates have $H^{*}(\mathrm{EXACT}_{n,k}) = 2$ for $1 \leq k \leq n - 1$.

**Proof.** [lemmas/06_symmetric_sign_changes.md](lemmas/06_symmetric_sign_changes.md)
...
**Proof.** [lemmas/07_positive_projection_sign_changes.md](lemmas/07_positive_projection_sign_changes.md)
...
**Proof.** [lemmas/08_three_bit_projection_cases.md](lemmas/08_three_bit_projection_cases.md)
...
**Proof.** [lemmas/09_three_bit_quadratic_upper_bound.md](lemmas/09_three_bit_quadratic_upper_bound.md)
...
**Proof.** [lemmas/10_three_bit_exact_classification.md](lemmas/10_three_bit_exact_classification.md)
...
**Proof.** [lemmas/11_four_bit_universal_upper_bound.md](lemmas/11_four_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/12_five_bit_universal_upper_bound.md](lemmas/12_five_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/13_six_bit_universal_upper_bound.md](lemmas/13_six_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/14_seven_bit_universal_upper_bound.md](lemmas/14_seven_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/15_determinant_span_schema.md](lemmas/15_determinant_span_schema.md)
...
**Proof.** [lemmas/16_eight_bit_universal_upper_bound.md](lemmas/16_eight_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/17_nine_bit_universal_upper_bound.md](lemmas/17_nine_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/18_ten_bit_universal_upper_bound.md](lemmas/18_ten_bit_universal_upper_bound.md)
...
**Proof.** [lemmas/19_compact_threshold_certificates.md](lemmas/19_compact_threshold_certificates.md)
...
**Proof.** [lemmas/20_counting_lower_bound.md](lemmas/20_counting_lower_bound.md)
...
**Proof.** [lemmas/21_top_threshold_degree.md](lemmas/21_top_threshold_degree.md)
...
For a partition $I\sqcup J=\{1,\ldots,n\}$, let $\operatorname{srank}_{I,J}(f)$ be the sign-rank of the corresponding communication matrix of $f$. Then
...
**Proof.** [lemmas/22_restrictions_and_sign_rank.md](lemmas/22_restrictions_and_sign_rank.md)
...
Equivalently, if $\operatorname{mDNF}(f)$ is the minimum number of nonempty terms in a monotone DNF for $f$, with $\operatorname{mDNF}(0)=\operatorname{mDNF}(1)=0$, then every monotone Boolean function satisfies
...
**Proof.** [lemmas/23_monotone_dnf_upper_bound.md](lemmas/23_monotone_dnf_upper_bound.md)
...
with $M\in\{1,x_1,\ldots,x_n\}$ span all multilinear polynomials of degree at most $d$ on $\{0,1\}^n$. Then every Boolean function with
...
**Proof.** [lemmas/24_threshold_degree_span_schema.md](lemmas/24_threshold_degree_span_schema.md)

### Lemma 31. Fourier tail threshold-degree criterion

Let $q : \{-1,1\}^n \to \{-1,1\}$ be the sign-valued version of $f$, with Fourier expansion
...
**Proof.** [lemmas/25_fourier_tail_threshold_degree.md](lemmas/25_fourier_tail_threshold_degree.md)
...
**Proof.** [lemmas/26_denominator_orientation.md](lemmas/26_denominator_orientation.md)
...
For any Boolean operation $G:\{0,1\}^m\to\{0,1\}$, define
...
**Proof.** [lemmas/27_shared_projection_closure.md](lemmas/27_shared_projection_closure.md)
...
**Proof.** [lemmas/28_dnf_cnf_width_threshold_degree.md](lemmas/28_dnf_cnf_width_threshold_degree.md)

### Lemma 35. Monotone antichain upper bound

Let $f : \{0,1\}^n \to \{0,1\}$ be monotone. Let $\mathcal{M}_1(f)$ be the family of minimal true sets, and let $\mathcal{M}_0(f)$ be the family of maximal false sets. Then
...
**Proof.** [lemmas/29_monotone_antichain_upper_bound.md](lemmas/29_monotone_antichain_upper_bound.md)
...
**Proof.** [lemmas/30_monotone_counting_lower_bound.md](lemmas/30_monotone_counting_lower_bound.md)
...
**Proof.** [lemmas/31_sparse_support_upper_bound.md](lemmas/31_sparse_support_upper_bound.md)
...
**Proof.** [lemmas/32_dnf_cnf_volume_upper_bound.md](lemmas/32_dnf_cnf_volume_upper_bound.md)
...
**Proof.** [lemmas/33_junta_upper_bounds.md](lemmas/33_junta_upper_bounds.md)
...
Equivalently, if $\operatorname{certvol}_b(f)$ is the minimum weighted cylinder volume of a $b$-certificate cover, then
...
**Proof.** [lemmas/34_certificate_cover_upper_bound.md](lemmas/34_certificate_cover_upper_bound.md)

### Lemma 41. Polynomial-threshold sparsity upper bound

Let $\operatorname{ptfsp}(f)$ be the minimum number of nonconstant monomials appearing with nonzero coefficient in a real polynomial that sign-represents $f$ on the Boolean cube. Then
...
**Proof.** [lemmas/35_ptf_sparsity_upper_bound.md](lemmas/35_ptf_sparsity_upper_bound.md)
...
**Proof.** [lemmas/36_dnf_cnf_literal_expansion_upper_bound.md](lemmas/36_dnf_cnf_literal_expansion_upper_bound.md)
...
**Proof.** [lemmas/37_decision_tree_upper_bound.md](lemmas/37_decision_tree_upper_bound.md)
...
**Proof.** [lemmas/38_oriented_certificate_expansion_upper_bound.md](lemmas/38_oriented_certificate_expansion_upper_bound.md)

### Lemma 45. Fourier support-cost upper bound

Let $q:\{0,1\}^n\to\{-1,1\}$ be the sign-valued version of $f$. Suppose
...
**Proof.** [lemmas/39_fourier_support_upper_bound.md](lemmas/39_fourier_support_upper_bound.md)
...
**Proof.** [lemmas/40_affine_parity_exact.md](lemmas/40_affine_parity_exact.md)
...
**Proof.** [lemmas/41_inner_product_bounds.md](lemmas/41_inner_product_bounds.md)

### Lemma 48. Affine-free polynomial-threshold sparsity upper bound

Let $\operatorname{afs}_{\pm}(f)$ be the minimum, over all sign-representing multilinear polynomials $P$, of the number of degree at least two monomials in $P$, plus one extra unit if the linear part of $P$ is nonzero. Then
...
**Proof.** [lemmas/42_affine_free_sparsity_upper_bound.md](lemmas/42_affine_free_sparsity_upper_bound.md)
...
**Proof.** [lemmas/43_equality_bounds.md](lemmas/43_equality_bounds.md)

### Lemma 50. Intersection-profile bounds

Let $F:\{0,1,\ldots,m\}\to\{0,1\}$ and define
...
**Proof.** [lemmas/44_intersection_profile_bounds.md](lemmas/44_intersection_profile_bounds.md)
...
**Proof.** [lemmas/45_hamming_distance_profile_bounds.md](lemmas/45_hamming_distance_profile_bounds.md)
...
**Proof.** [lemmas/46_directed_defect_profile_bounds.md](lemmas/46_directed_defect_profile_bounds.md)

### Lemma 53. Local-pattern count profile schema

Let $p:\{0,1\}^2\to\{0,1\}$ be a two-bit predicate and define
...
**Proof.** [lemmas/47_local_pattern_count_profile_schema.md](lemmas/47_local_pattern_count_profile_schema.md)
...
**Proof.** [lemmas/48_three_bit_threshold_vote_invariant.md](lemmas/48_three_bit_threshold_vote_invariant.md)
...
**Proof.** [lemmas/49_equality_threshold_vote_size.md](lemmas/49_equality_threshold_vote_size.md)
...
**Proof.** [lemmas/50_two_pair_equality_exact.md](lemmas/50_two_pair_equality_exact.md)
...
**Proof.** [lemmas/51_two_pair_containment_exact.md](lemmas/51_two_pair_containment_exact.md)

### Lemma 58. Two-pair local-count thresholds use at most two heads

Let $p:\{0,1\}^2\to\{0,1\}$ be any two-bit predicate and let $F:\{0,1,2\}\to\{0,1\}$ have exactly one sign change. Define
...
**Proof.** [lemmas/52_two_pair_local_count_thresholds.md](lemmas/52_two_pair_local_count_thresholds.md)
...
**Proof.** [lemmas/53_three_pair_endpoint_exact.md](lemmas/53_three_pair_endpoint_exact.md)
...
**Proof.** [lemmas/54_equality_exact_two_heads.md](lemmas/54_equality_exact_two_heads.md)
...
be an affine function on $\{0,1\}^n$, and define
...
**Proof.** [lemmas/55_affine_level_set_upper_bound.md](lemmas/55_affine_level_set_upper_bound.md)
...
be an affine function on $\{0,1\}^n$, and let $\alpha\leq\beta$. Define
...
**Proof.** [lemmas/56_affine_slab_upper_bound.md](lemmas/56_affine_slab_upper_bound.md)

### Lemma 63. Affine statistic sign-change upper bound

Let $L$ be affine on $\{0,1\}^n$, let $G:\operatorname{Im}(L)\to\{0,1\}$, and define
...
3. If $C_L(G)=2$, then $H^{*}(f)$ is $1$ if $f$ is a nonconstant LTF and $2$ otherwise.
...
**Proof.** [lemmas/57_affine_statistic_sign_changes.md](lemmas/57_affine_statistic_sign_changes.md)
...
**Proof.** [lemmas/58_two_point_support_exact.md](lemmas/58_two_point_support_exact.md)

### Lemma 65. Affine hull clean supports use at most two heads

Let $A\subseteq\{0,1\}^n$ be nonempty and affine hull clean, meaning
...
**Proof.** [lemmas/59_affine_hull_clean_supports.md](lemmas/59_affine_hull_clean_supports.md)
...
**Proof.** [lemmas/60_positive_run_upper_bound.md](lemmas/60_positive_run_upper_bound.md)
...
only if some partition $I\sqcup J=\{1,\ldots,n\}$ satisfies
...
**Proof.** [lemmas/61_sign_rank_method_limitations.md](lemmas/61_sign_rank_method_limitations.md)
...
**Proof.** [lemmas/62_positive_one_run_exact.md](lemmas/62_positive_one_run_exact.md)
...
**Proof.** [lemmas/63_positive_projection_degree_tight_exact.md](lemmas/63_positive_projection_degree_tight_exact.md)
...
**Proof.** [lemmas/64_low_affine_free_support_exact.md](lemmas/64_low_affine_free_support_exact.md)
...
**Proof.** [lemmas/65_depth_two_decision_trees_exact.md](lemmas/65_depth_two_decision_trees_exact.md)
...
**Proof.** [lemmas/66_decision_tree_hybrid_upper_bound.md](lemmas/66_decision_tree_hybrid_upper_bound.md)
...
**Proof.** [lemmas/67_dnf_cnf_hybrid_upper_bound.md](lemmas/67_dnf_cnf_hybrid_upper_bound.md)

### Lemma 74. Cofactor sparse-polynomial recursion

Write inputs as $(z,y)\in\{0,1\}\times\{0,1\}^{n-1}$, and let
...
**Proof.** [lemmas/68_cofactor_sparse_polynomial_recursion.md](lemmas/68_cofactor_sparse_polynomial_recursion.md)
...
**Proof.** [lemmas/69_affine_free_cofactor_recursion.md](lemmas/69_affine_free_cofactor_recursion.md)

### Lemma 76. LTF cofactor slope distance

Write inputs as $(z,y)\in\{0,1\}\times\{0,1\}^{n-1}$, and let $f_0(y)=f(0,y)$ and $f_1(y)=f(1,y)$. Suppose $f_0$ and $f_1$ have affine sign representations
...
**Proof.** [lemmas/70_ltf_cofactor_slope_distance.md](lemmas/70_ltf_cofactor_slope_distance.md)
...
**Proof.** [lemmas/71_split_ltf_slope_invariant.md](lemmas/71_split_ltf_slope_invariant.md)
...
Let $\operatorname{scafs}_{\pm}(f)$ be the minimum of $C(P_0,P_1)$ over all split coordinates and all strict cofactor sign representations. Then
...
If $\operatorname{scafs}_{\pm}(f)\leq2$, then $H^{*}(f)$ has the exact constant, nonconstant LTF, or otherwise two-head split.
...
**Proof.** [lemmas/72_split_affine_free_support_invariant.md](lemmas/72_split_affine_free_support_invariant.md)
...
**Proof.** [lemmas/73_one_bit_ltf_branching.md](lemmas/73_one_bit_ltf_branching.md)
...
For any Boolean gate $G:\{0,1\}^2\to\{0,1\}$, define

$$
f(z,y):=G(z,T(y)).
$$

For $b\in\{0,1\}$, let $\mu_b=1$ if $G(b,u)=u$, let $\mu_b=-1$ if $G(b,u)=1-u$, and let $\mu_b=0$ if $G(b,u)$ is constant. Then
...
**Proof.** [lemmas/74_one_bit_sparse_ptf_branching.md](lemmas/74_one_bit_sparse_ptf_branching.md)
...
**Proof.** [lemmas/75_fresh_bit_xor_threshold_degree.md](lemmas/75_fresh_bit_xor_threshold_degree.md)

### Lemma 82. One-bit gate threshold-degree trichotomy

Let $T:\{0,1\}^{m}\to\{0,1\}$ be nonconstant, set $d:=\deg_{\pm}(T)$, and define

$$
F(z,y):=G(z,T(y))
$$

for an arbitrary gate $G:\{0,1\}^{2}\to\{0,1\}$. For $b\in\{0,1\}$, write $G_b(u):=G(b,u)$.
...
**Proof.** [lemmas/76_one_bit_gate_threshold_degree_trichotomy.md](lemmas/76_one_bit_gate_threshold_degree_trichotomy.md)
...
**Proof.** [lemmas/77_parity_block_threshold_degree_amplifier.md](lemmas/77_parity_block_threshold_degree_amplifier.md)

### Lemma 84. Parity-block restriction lower bound

Let $f:\{0,1\}^{n}\to\{0,1\}$. Suppose a restriction of $f$ leaves two disjoint sets of free variables $Z$ and $Y$, with $\lvert Z\rvert=k$, and on that restricted subcube has the form
...
**Proof.** [lemmas/78_parity_block_restriction_lower_bound.md](lemmas/78_parity_block_restriction_lower_bound.md)

### Lemma 85. Calibrated threshold-vote upper bound

Let $T_1,\ldots,T_s:\{0,1\}^{n}\to\{0,1\}$ be Boolean features, and define
...
**Proof.** [lemmas/79_calibrated_threshold_vote_upper_bound.md](lemmas/79_calibrated_threshold_vote_upper_bound.md)
...
**Proof.** [lemmas/80_endpoint_affine_threshold_vote_upper_bound.md](lemmas/80_endpoint_affine_threshold_vote_upper_bound.md)

### Lemma 87. One-bit non-XOR gate recursion

Let $T : \{0,1\}^{m}\to\{0,1\}$ be any Boolean function, and let
...
**Proof.** [lemmas/81_one_bit_non_xor_gate_recursion.md](lemmas/81_one_bit_non_xor_gate_recursion.md)
...
**Proof.** [lemmas/82_literal_decision_list_upper_bound.md](lemmas/82_literal_decision_list_upper_bound.md)
...
**Proof.** [lemmas/83_endpoint_decision_list_upper_bound.md](lemmas/83_endpoint_decision_list_upper_bound.md)
...
**Proof.** [lemmas/84_calibrated_decision_list_upper_bound.md](lemmas/84_calibrated_decision_list_upper_bound.md)
...
**Proof.** [lemmas/85_internal_ltf_indicator_obstruction.md](lemmas/85_internal_ltf_indicator_obstruction.md)
...
**Proof.** [lemmas/86_internal_ltf_indicator_infimum.md](lemmas/86_internal_ltf_indicator_infimum.md)
...
Moreover, if $\operatorname{eafs}(T)$ is the exact affine-free support cost of the unique multilinear expansion of $T$, then
...
**Proof.** [lemmas/87_raw_calibrated_vote_support_bound.md](lemmas/87_raw_calibrated_vote_support_bound.md)
...
**Proof.** [lemmas/88_raw_calibrated_decision_list_support_bound.md](lemmas/88_raw_calibrated_decision_list_support_bound.md)
...
\qquad
\max\{\rho(T_1),\rho(T_2)\}\geq\frac{\deg_{\pm}(f)}{2}.
$$
...
**Proof.** [lemmas/89_raw_calibration_threshold_degree_lower_bound.md](lemmas/89_raw_calibration_threshold_degree_lower_bound.md)
...
**Proof.** [lemmas/90_subcube_raw_calibration_cost.md](lemmas/90_subcube_raw_calibration_cost.md)
...
**Proof.** [lemmas/91_raw_calibration_invariances.md](lemmas/91_raw_calibration_invariances.md)
...
**Proof.** [lemmas/92_subcube_threshold_vote_upper_bound.md](lemmas/92_subcube_threshold_vote_upper_bound.md)

### Lemma 99. Cylinder-threshold cost invariant

Let $\operatorname{ctc}(f)$ be the minimum, over all strict real threshold representations of $f$ by subcube indicators $C_{P_a,N_a}$, of
...
Moreover, $\operatorname{ctc}(f)<\infty$ for every Boolean function.
...
**Proof.** [lemmas/93_cylinder_threshold_cost_invariant.md](lemmas/93_cylinder_threshold_cost_invariant.md)

### Lemma 100. Cylinder-threshold cost invariances

The cylinder-threshold cost $\operatorname{ctc}(f)$ is invariant under output complement, coordinate permutation, global bit-flip, and dummy-variable extension. It is monotone under restrictions: if $g$ is a restriction of $f$, then
...
**Proof.** [lemmas/94_cylinder_threshold_cost_invariances.md](lemmas/94_cylinder_threshold_cost_invariances.md)
...
**Proof.** [lemmas/95_cylinder_threshold_cost_subsumes_local_certificates.md](lemmas/95_cylinder_threshold_cost_subsumes_local_certificates.md)

### Lemma 102. Cylinder-threshold cost and PTF sparsity

Let $\operatorname{ptfsp}(f)$ be the least number of nonconstant monomials in a real multilinear polynomial that sign-represents $f$. Then
...
**Proof.** [lemmas/96_cylinder_threshold_cost_ptf_sparsity.md](lemmas/96_cylinder_threshold_cost_ptf_sparsity.md)

### Lemma 103. Affine-cylinder threshold cost

Let $\operatorname{actc}(f)$ be the minimum, over all strict representations
...
**Proof.** [lemmas/97_affine_cylinder_threshold_cost.md](lemmas/97_affine_cylinder_threshold_cost.md)

### Lemma 104. Affine-cylinder cost hierarchy

Let $\operatorname{afs}_{\pm}(f)$ be affine-free polynomial-threshold sparsity. Then
...
**Proof.** [lemmas/98_affine_cylinder_cost_hierarchy.md](lemmas/98_affine_cylinder_cost_hierarchy.md)
...
**Proof.** [lemmas/99_halfspace_intersection_head_lower_bound.md](lemmas/99_halfspace_intersection_head_lower_bound.md)

### Lemma 106. Threshold-vote and LTF decision-list separation

Let $s_{\mathrm{LTF}}(f)$ be the minimum number of LTF indicators in a strict weighted vote for $f$. There is an infinite family $F_n:\{0,1\}^{n}\to\{0,1\}$ such that
...
Thus neither threshold-vote size nor LTF decision-list length is a constant-factor upper bound for $H^{*}$.
...
**Proof.** [lemmas/100_threshold_vote_and_ltf_decision_list_separation.md](lemmas/100_threshold_vote_and_ltf_decision_list_separation.md)
...
**Proof.** [lemmas/101_ltf_raw_calibration_linear_lower_bound.md](lemmas/101_ltf_raw_calibration_linear_lower_bound.md)

### Lemma 108. Affine-cylinder threshold cost invariances

The affine-cylinder threshold cost $\operatorname{actc}(f)$ is invariant under output complement, coordinate permutation, global bit-flip, and dummy-variable extension. It is monotone under restrictions: if $g$ is a restriction of $f$, then
...
**Proof.** [lemmas/102_affine_cylinder_threshold_cost_invariances.md](lemmas/102_affine_cylinder_threshold_cost_invariances.md)
...
**Proof.** [lemmas/103_low_affine_cylinder_cost_exactness.md](lemmas/103_low_affine_cylinder_cost_exactness.md)
...
**Proof.** [lemmas/104_affine_cylinder_threshold_degree_sandwich.md](lemmas/104_affine_cylinder_threshold_degree_sandwich.md)
...
Let $\Delta_{\mathrm{lin}}=\{i:\alpha_{1,i}\neq\alpha_{0,i}\}$ and $\Delta_{\mathrm{cyl}}=\{\gamma:c_{1,\gamma}\neq c_{0,\gamma}\}$ after missing cylinder coefficients are interpreted as $0$. Then
...
**Proof.** [lemmas/105_affine_cylinder_cofactor_interpolation.md](lemmas/105_affine_cylinder_cofactor_interpolation.md)

### Lemma 112. Split affine-cylinder cost

Let $f:\{0,1\}^{n}\to\{0,1\}$ with $n\geq1$. For each split coordinate $j$, write the cofactors as $f_0,f_1$. Given strict affine-cylinder cofactor scores $S_0,S_1$, let $I(S_0,S_1)$ be the interpolation cost from Lemma 111. Define
...
If $\operatorname{sactc}(f)\leq2$, then $H^{*}(f)$ has the exact constant, nonconstant LTF, or two-head split.

> **Interpretation.** The split affine-cylinder cost packages cofactor interpolation as a recursive certificate invariant.

**Proof.** [lemmas/106_split_affine_cylinder_cost.md](lemmas/106_split_affine_cylinder_cost.md)
...
**Proof.** [lemmas/107_shared_cylinder_split_exactness.md](lemmas/107_shared_cylinder_split_exactness.md)

### Lemma 114. Split affine-cylinder refines split affine-free support

For every Boolean function $f:\{0,1\}^{n}\to\{0,1\}$ with $n\geq1$,
...
where $\operatorname{scafs}_{\pm}$ is the split affine-free support invariant from Lemma 78.
...
**Proof.** [lemmas/108_split_affine_cylinder_refines_split_affine_free.md](lemmas/108_split_affine_cylinder_refines_split_affine_free.md)
...
Equivalently, $\operatorname{actc}(f)\geq2$ exactly when $f$ is neither constant nor a nonconstant LTF.

> **Interpretation.** The affine-cylinder cost has the same constant and one-head levels as $H^{*}$.

**Proof.** [lemmas/109_affine_cylinder_first_levels_exact.md](lemmas/109_affine_cylinder_first_levels_exact.md)
...
Equivalently, $\operatorname{sactc}(f)\geq2$ exactly when $f$ is neither constant nor a nonconstant LTF.
...
**Proof.** [lemmas/110_split_affine_cylinder_first_levels_exact.md](lemmas/110_split_affine_cylinder_first_levels_exact.md)

### Lemma 117. Pure-cylinder affine perturbations are exact

Let $P,N\subseteq\{1,\ldots,n\}$ be disjoint with either $P=\varnothing$ or $N=\varnothing$. Suppose
...
**Proof.** [lemmas/111_pure_cylinder_affine_perturbation_exact.md](lemmas/111_pure_cylinder_affine_perturbation_exact.md)

### Lemma 118. One-bit affine-cylinder branching

Let $T:\{0,1\}^{m}\to\{0,1\}$ have a strict affine-cylinder score
...
Let $F(z,y)=G(z,T(y))$ for an arbitrary two-input Boolean gate $G$. For $b\in\{0,1\}$, let $\mu_b\in\{-1,0,1\}$ record whether the $b$th slice of $G$ is $u$, $1-u$, or constant as a function of $u$. Let $\delta_b$ be the strict constant score for the constant slice when $\mu_b=0$, and $0$ otherwise. Define
...
**Proof.** [lemmas/112_one_bit_affine_cylinder_branching.md](lemmas/112_one_bit_affine_cylinder_branching.md)
...
**Proof.** [lemmas/113_fresh_bit_xor_affine_cylinder_bound.md](lemmas/113_fresh_bit_xor_affine_cylinder_bound.md)

### Lemma 120. Affine-cylinder cofactor recursion

Let $f:\{0,1\}\times\{0,1\}^{m}\to\{0,1\}$ have cofactors $f_0,f_1$, and let
...
**Proof.** [lemmas/114_affine_cylinder_cofactor_recursion.md](lemmas/114_affine_cylinder_cofactor_recursion.md)
...
Let $r(z)$ be either $z$ or $1-z$, and let $L(A)=\{i:\alpha_i\neq0\}$. Define $K_r(\Gamma)$ by lifting every cylinder through the literal $r$: if $r=z$, use $\kappa(P\cup\{z\},N)$, and if $r=1-z$, use $\kappa(P,N\cup\{z\})$.
...
**Proof.** [lemmas/115_literal_gated_affine_cylinder_feature.md](lemmas/115_literal_gated_affine_cylinder_feature.md)
...
where the minimum ranges over strict affine-cylinder scores for $T$. Then for either literal $r(z)\in\{z,1-z\}$,
...
**Proof.** [lemmas/116_lifted_literal_gating_cost.md](lemmas/116_lifted_literal_gating_cost.md)

### Lemma 123. Non-XOR gates through lifted cost

Let $T:\{0,1\}^{m}\to\{0,1\}$ be any Boolean function, and let $G:\{0,1\}^{2}\to\{0,1\}$ be a two-input Boolean gate that is neither XOR nor XNOR. Define
...
1. If $G$ is constant or depends only on $z$, then $H^{*}(F)\leq1$.

2. If $G$ depends only on its second input, then $H^{*}(F)\leq\operatorname{actc}(T)$.
...
**Proof.** [lemmas/117_non_xor_gate_lifted_cost.md](lemmas/117_non_xor_gate_lifted_cost.md)
...
**Proof.** [lemmas/118_fresh_bit_xor_target_cost.md](lemmas/118_fresh_bit_xor_target_cost.md)
...
The optimized one-bit costs $\operatorname{lgactc}(T)$ and $\operatorname{xactc}(T)$ have the following properties:
...
**Proof.** [lemmas/119_optimized_one_bit_cost_invariances.md](lemmas/119_optimized_one_bit_cost_invariances.md)
...
**Proof.** [lemmas/120_endpoint_feature_fresh_xor_exact.md](lemmas/120_endpoint_feature_fresh_xor_exact.md)
...
**Proof.** [lemmas/121_affine_endpoint_fresh_xor_exact.md](lemmas/121_affine_endpoint_fresh_xor_exact.md)
...
be a nonconstant affine statistic on $\{0,1\}^{m}$, and let $E$ be either endpoint predicate $E_{\min}$ or $E_{\max}$. For any two-input Boolean gate $G:\{0,1\}^{2}\to\{0,1\}$, define
...
**Proof.** [lemmas/122_affine_endpoint_one_bit_gate_classification.md](lemmas/122_affine_endpoint_one_bit_gate_classification.md)
...
**Proof.** [lemmas/123_ltf_one_bit_gate_classification.md](lemmas/123_ltf_one_bit_gate_classification.md)
...
be an affine statistic on $\{0,1\}^{m}$, let $G:\operatorname{Im}(L)\to\{0,1\}$, and define $T(y):=G(L(y))$. Let $C$ be the number of sign changes of $G$ along the ordered image of $L$, and set
...
**Proof.** [lemmas/124_fresh_xor_affine_statistic_sign_change_bound.md](lemmas/124_fresh_xor_affine_statistic_sign_change_bound.md)
...
let $G:\operatorname{Im}(t)\to\{0,1\}$, and define $T(y):=G(t(y))$. Let $C$ be the number of sign changes of $G$ along the ordered image of $t$, and set
...
**Proof.** [lemmas/125_positive_projection_fresh_xor_sign_change_bound.md](lemmas/125_positive_projection_fresh_xor_sign_change_bound.md)
...
**Proof.** [lemmas/126_positive_projection_one_bit_gate_bound.md](lemmas/126_positive_projection_one_bit_gate_bound.md)
...
with all three displayed blocks nonempty. For either raw literal $r(z)\in\{z,1-z\}$,
...
**Proof.** [lemmas/127_internal_positive_slab_literal_gate_exact.md](lemmas/127_internal_positive_slab_literal_gate_exact.md)
...
5. gates of the form $r\wedge(1-S)$ and their complements satisfy $2\leq H^{*}\leq3$;
6. XOR and XNOR satisfy $3\leq H^{*}\leq5$.
...
**Proof.** [lemmas/128_internal_positive_slab_gate_table.md](lemmas/128_internal_positive_slab_gate_table.md)
...
**Proof.** [lemmas/135_positive_statistic_raw_bit_quadratic_span.md](lemmas/135_positive_statistic_raw_bit_quadratic_span.md)
...
**Proof.** [lemmas/136_positive_statistic_raw_bit_cubic_span.md](lemmas/136_positive_statistic_raw_bit_cubic_span.md)
...
**Proof.** [lemmas/137_internal_positive_slab_exact_gate_table.md](lemmas/137_internal_positive_slab_exact_gate_table.md)
...
**Proof.** [lemmas/138_positive_statistic_raw_bit_degree_span.md](lemmas/138_positive_statistic_raw_bit_degree_span.md)
...
**Proof.** [lemmas/139_positive_statistic_fresh_xor_sign_change_bound.md](lemmas/139_positive_statistic_fresh_xor_sign_change_bound.md)
...
**Proof.** [lemmas/140_positive_statistic_non_xor_gate_sign_change_bound.md](lemmas/140_positive_statistic_non_xor_gate_sign_change_bound.md)
...
**Proof.** [lemmas/141_degree_tight_positive_statistic_gate_classification.md](lemmas/141_degree_tight_positive_statistic_gate_classification.md)

### Lemma 142. Symmetric-feature one-bit gate exactness

Let $T:\{0,1\}^{m}\to\{0,1\}$ be a nonconstant symmetric Boolean function, and let $C$ be the number of sign changes in its Hamming-weight sequence. For any two-input Boolean gate $G$, define $H_G(z,y):=G(z,T(y))$. Then
...
**Proof.** [lemmas/142_symmetric_feature_one_bit_gate_exact.md](lemmas/142_symmetric_feature_one_bit_gate_exact.md)
...
**Proof.** [lemmas/143_positive_statistic_one_bit_gate_sandwich.md](lemmas/143_positive_statistic_one_bit_gate_sandwich.md)

### Lemma 144. Positive-order one-bit gate sandwich

Let $f:\{0,1\}^{m}\to\{0,1\}$, and let $C_{+}(f)$ be the optimized positive-projection sign-change count. For any two-input Boolean gate $G$, define $H_G(z,y):=G(z,f(y))$. Constants cost $0$, raw-bit literals cost $1$, and if $f$ is nonconstant, XOR and XNOR satisfy
...
**Proof.** [lemmas/144_positive_order_one_bit_gate_sandwich.md](lemmas/144_positive_order_one_bit_gate_sandwich.md)

### Lemma 145. Common positive-statistic multi-slice bound

Let $k\geq0$, let $z\in\{0,1\}^{k}$ be raw bits, and let $t(y)=\sum_i\lambda_i y_i$ have positive coefficients. Suppose every raw-bit slice factors through $t$:
...
**Proof.** [lemmas/145_common_positive_statistic_multi_slice_bound.md](lemmas/145_common_positive_statistic_multi_slice_bound.md)
...
**Proof.** [lemmas/146_multi_raw_positive_statistic_degree_bound.md](lemmas/146_multi_raw_positive_statistic_degree_bound.md)
...
**Proof.** [lemmas/147_ordered_common_positive_statistic_slice_bound.md](lemmas/147_ordered_common_positive_statistic_slice_bound.md)
...
for a Boolean gate $G:\{0,1\}^{k}\times\{0,1\}\to\{0,1\}$. For a chosen positive raw-slice order, let $N_G$ be the number of raw assignments whose slice is $T$ or $1-T$, and let $J_{\rho,G}$ be the number of actual boundary jumps between consecutive raw slices. Then
...
**Proof.** [lemmas/148_multi_raw_gate_positive_statistic_feature_bound.md](lemmas/148_multi_raw_gate_positive_statistic_feature_bound.md)

### Lemma 149. Optimized ordered positive-statistic slice cost

For a split $f(z,y)$ with $k\geq1$ raw bits, define $\operatorname{osc}_{+}^{z\mid y}(f)$ by minimizing, over all common positive-statistic certificates $t(y)$ for the raw slices and all positive raw-slice orders $\rho$, the cost

$$
\Omega_{t,\rho}(f)
=
\sum_{a\in\{0,1\}^{k}} C_a+J_{t,\rho}(f),
$$
...
**Proof.** [lemmas/149_optimized_ordered_positive_statistic_slice_cost.md](lemmas/149_optimized_ordered_positive_statistic_slice_cost.md)
...
**Proof.** [lemmas/150_ordered_slice_degree_bound.md](lemmas/150_ordered_slice_degree_bound.md)

### Lemma 151. Positive mixed boundary gate bound

For raw functions $p,q:\{0,1\}^{k}\to\{0,1\}$, let $B_{+}(p,q)$ be the minimum, over positive raw orders, of the number of adjacent mixed transitions $p(a^{(r)})\neq q(a^{(r+1)})$.
...
For a gate $G:\{0,1\}^{k}\times\{0,1\}\to\{0,1\}$, put $g_e(a)=G(a,e)$ and $N_G=\lvert\{a:g_0(a)\neq g_1(a)\}\rvert$. Then
...
**Proof.** [lemmas/151_positive_mixed_boundary_gate_bound.md](lemmas/151_positive_mixed_boundary_gate_bound.md)
...
**Proof.** [lemmas/152_equal_endpoint_multi_raw_gate_bound.md](lemmas/152_equal_endpoint_multi_raw_gate_bound.md)

### Lemma 153. Mixed boundary inequality

For raw functions $p,q:\{0,1\}^{k}\to\{0,1\}$, let
...
**Proof.** [lemmas/153_mixed_boundary_inequality.md](lemmas/153_mixed_boundary_inequality.md)

### Lemma 154. Raw-mask gate endpoint bounds

Let $R:\{0,1\}^{k}\to\{0,1\}$ be a raw mask, let $T(y)=F(t(y))$ have sign-change count $C$, and put $e_0=F(\tau_0)$, $e_1=F(\tau_{M-1})$. Let
...
**Proof.** [lemmas/154_raw_mask_gate_endpoint_bounds.md](lemmas/154_raw_mask_gate_endpoint_bounds.md)

### Theorem 155. Multi-raw gate sandwich and single-slice exactness

Let $T(y)=F(t(y))$ be a nonconstant positive-statistic feature with sign-change count $C$, and let $G:\{0,1\}^{k}\times\{0,1\}\to\{0,1\}$. Put $H_G(z,y)=G(z,T(y))$, $g_e(a)=G(a,e)$, and $N_G=\lvert\{a:g_0(a)\neq g_1(a)\}\rvert$. Then
...
**Proof.** [lemmas/155_multi_raw_gate_sandwich_exactness.md](lemmas/155_multi_raw_gate_sandwich_exactness.md)
...
**Proof.** [lemmas/156_address_localization_exactness.md](lemmas/156_address_localization_exactness.md)
...
**Proof.** [lemmas/157_few_run_raw_mask_gate_theorem.md](lemmas/157_few_run_raw_mask_gate_theorem.md)

### Theorem 158. Shared-statistic slice sandwich

Let $f(a,y)=F_a(t(y))$ for every raw assignment $a\in\{0,1\}^{k}$, where $t$ is one positive statistic. Let $C_a$ be the sign-change count of $F_a$ along the ordered image of $t$, and define endpoint raw functions
...
**Proof.** [lemmas/158_shared_statistic_slice_sandwich.md](lemmas/158_shared_statistic_slice_sandwich.md)
...
**Proof.** [lemmas/159_shared_statistic_degree_sandwich.md](lemmas/159_shared_statistic_degree_sandwich.md)

### Theorem 160. Addressed common-endpoint direct sum

Let $A\subseteq\{0,1\}^{k}$ be a set of raw addresses. For each $a\in A$, let
...
**Proof.** [lemmas/160_addressed_common_endpoint_direct_sum.md](lemmas/160_addressed_common_endpoint_direct_sum.md)
...
where $D(p,q)=\lvert\{a:p(a)\neq q(a)\}\rvert$. If $p$ and $q$ have few-run certificates in positive raw orders, with run costs $K_p$ and $K_q$, then
...
**Proof.** [lemmas/161_endpoint_variation_shared_statistic_bound.md](lemmas/161_endpoint_variation_shared_statistic_bound.md)
...
The same exactness criterion holds with $L_{\rho}(f)$ replaced by the optimized endpoint-coupled cost $\operatorname{eps}_{+}^{z\mid y}(f)$.
...
**Proof.** [lemmas/162_positive_concatenation_exactness_criterion.md](lemmas/162_positive_concatenation_exactness_criterion.md)
...
**Proof.** [lemmas/163_endpoint_coupled_slice_cost_invariant.md](lemmas/163_endpoint_coupled_slice_cost_invariant.md)
...
$$
A:=\{a:F_a(t(y))\text{ is nonconstant}\}
$$
...
**Proof.** [lemmas/164_sparse_slice_endpoint_coupled_bound.md](lemmas/164_sparse_slice_endpoint_coupled_bound.md)
...
**Proof.** [lemmas/165_positive_grid_slice_sandwich.md](lemmas/165_positive_grid_slice_sandwich.md)
...
**Proof.** [lemmas/166_positive_grid_degree_exactness.md](lemmas/166_positive_grid_degree_exactness.md)
...
**Proof.** [lemmas/167_hamming_layer_positive_grid_bound.md](lemmas/167_hamming_layer_positive_grid_bound.md)
...
**Proof.** [lemmas/168_sparse_raw_level_positive_grid_bound.md](lemmas/168_sparse_raw_level_positive_grid_bound.md)

### Theorem 169. Positive grid cost invariant

For a fixed split $(z,y)$, define $\operatorname{pgc}_{+}^{z\mid y}(f)$ by minimizing the positive-grid cost
...
The cost is invariant under output complement, raw-coordinate permutation, and feature-coordinate permutation. If $\deg_{\pm}(f)=\operatorname{pgc}_{+}^{z\mid y}(f)$, then $H^{*}(f)$ is exactly this value.
...
**Proof.** [lemmas/169_positive_grid_cost_invariant.md](lemmas/169_positive_grid_cost_invariant.md)
...
**Proof.** [lemmas/170_positive_lexicographic_multigrid_bound.md](lemmas/170_positive_lexicographic_multigrid_bound.md)
...
**Proof.** [lemmas/171_multi_hamming_profile_bound.md](lemmas/171_multi_hamming_profile_bound.md)
...
**Proof.** [lemmas/172_multigrid_run_bound.md](lemmas/172_multigrid_run_bound.md)

### Theorem 173. Positive multigrid cost invariant

Fix a partition $\mathcal{P}$ of the input variables into blocks. Define $\operatorname{mgc}_{+}^{\mathcal{P}}(f)$ as the minimum lexicographic grid-path sign-change count over all positive multigrid certificates for $f$ over $\mathcal{P}$ and all block orders. Then
...
The invariant is unchanged by output complement and by coordinate permutations preserving the partition up to relabeling. If $\deg_{\pm}(f)=\operatorname{mgc}_{+}^{\mathcal{P}}(f)$, then $H^{*}(f)$ equals this value.
...
**Proof.** [lemmas/173_positive_multigrid_cost_invariant.md](lemmas/173_positive_multigrid_cost_invariant.md)
...
let $\operatorname{mhc}(F)$ be the minimum lexicographic Hamming-grid sign-change count over all block orders. Then

$$
H^{*}(f)\leq\operatorname{mhc}(F).
$$

If $\deg_{\pm}(f)=\operatorname{mhc}(F)$, then $H^{*}(f)=\deg_{\pm}(f)=\operatorname{mhc}(F)$. If $R_{b,\pi}$ is the number of runs of label $b$ in the grid sequence for order $\pi$, then
...
**Proof.** [lemmas/174_block_order_hamming_profile_cost.md](lemmas/174_block_order_hamming_profile_cost.md)
...
**Proof.** [lemmas/175_positive_profile_projection_collapse.md](lemmas/175_positive_profile_projection_collapse.md)
...
let $f=\mathrm{XOR}_n$. Then, with $\operatorname{mhc}$ computed for the singleton Hamming profile of parity,
...
**Proof.** [lemmas/176_singleton_parity_multigrid_separation.md](lemmas/176_singleton_parity_multigrid_separation.md)
...
17. Lemma 17 uses Lemma 10 and a four-bit determinant decomposition to show that every four-bit Boolean function has $H^{*}(f) \leq 4$.
18. Lemma 18 uses Lemma 10 and a five-bit modular determinant certificate to show that every five-bit Boolean function has $H^{*}(f) \leq 7$.
19. Lemma 19 uses Lemma 10 and a six-bit modular determinant certificate to show that every six-bit Boolean function has $H^{*}(f) \leq 11$.
20. Lemma 20 uses Lemma 10 and a seven-bit modular determinant certificate to show that every seven-bit Boolean function has $H^{*}(f) \leq 19$.
21. Lemma 21 abstracts the determinant-span method behind Lemmas 17 to 20 and proves the method's dimension lower bound.
22. Lemma 22 applies Lemma 21 with an eight-bit modular determinant certificate to show that every eight-bit Boolean function has $H^{*}(f) \leq 32$.
23. Lemma 23 applies Lemma 21 with a nine-bit modular determinant certificate to show that every nine-bit Boolean function has $H^{*}(f) \leq 57$.
24. Lemma 24 applies Lemma 21 with a ten-bit modular determinant certificate to show that every ten-bit Boolean function has $H^{*}(f) \leq 103$.
...
29. Lemma 29 uses Lemmas 10 and 28 with a one-head same-sign-denominator construction to show that monotone DNF and CNF size upper-bound $H^{*}$ for monotone functions.
...
100. Lemma 100 uses the cylinder transformations behind Lemma 99 to prove symmetry invariance, dummy-variable invariance, and restriction monotonicity for $\operatorname{ctc}$.
...
102. Lemma 102 observes that every positive monomial is a cylinder of $\operatorname{ctc}$ cost $1$, so sparse PTF representations are feasible cylinder-threshold representations.
103. Lemma 103 combines affine approximation from Lemma 48 with the subcube raw calibration construction from Lemma 96.
104. Lemma 104 compares Lemma 103 with affine-free sparsity from Lemma 48, polynomial-threshold sparsity from Lemma 102, and $\operatorname{ctc}$ from Lemma 99.
...
120. Lemma 120 combines the cofactor interpolation rule from Lemma 111 with optimal cofactor affine-cylinder costs and the elementary inequality $\kappa(P\cup\{z\},N)\leq2\kappa(P,N)$.
...
The exact multilinear expansion of $T$ gives $\rho(T)\leq\operatorname{eafs}(T)$. For the internal LTF $x_1\wedge(x_2\vee x_3)$, this gives $\rho(T)\leq3$, while the one-atom obstruction gives $\rho(T)\neq1$.
...
Thus high-threshold-degree families force high $\operatorname{actc}$. In particular,

$$
\operatorname{actc}(\mathrm{XOR}_n)\geq n,
$$

and Sherstov's hard intersections of two halfspaces satisfy $\operatorname{actc}(F_n)\geq c n$.

There is also a cofactor interpolation rule for $\operatorname{actc}$. If two cofactors have affine-cylinder scores, one can glue them by

$$
S(z,y)=(1-z)S_0(y)+zS_1(y).
$$

The resulting cost pays for the base affine-cylinder certificate, for affine slopes that change across the split as cylinders $zy_i$, and for cylinder coefficients that change across the split as cylinders $zC_{P,N}$. Thus $\operatorname{actc}$ has a recursive search rule analogous to the split affine-free support invariant, but with mixed-literal cylinders replacing monomials.
...
Optimizing this certificate gives the cylinder-threshold cost invariant $\operatorname{ctc}(f)$:
...
The invariant $\operatorname{ctc}$ has the same basic structural behavior expected of a reusable Boolean-function cost. It is invariant under output complement, coordinate permutation, global bit-flip, and dummy-variable extension, and it is monotone under restrictions:
...
The $\operatorname{ctc}$ invariant also subsumes the local certificate-expansion route. A one-sided certificate cover gives a feasible strict cylinder-threshold score, so
...
for $b\in\{0,1\}$. Thus the DNF/CNF local-expansion and decision-tree leaf-profile costs are upper bounds on $\operatorname{ctc}(f)$ before converting to heads.

The ordinary sparse-PTF route also factors through $\operatorname{ctc}$. Every positive monomial $\prod_{i\in S}x_i$ is the cylinder $C_{S,\varnothing}$ with $\kappa(S,\varnothing)=1$, so
...
Thus $\operatorname{ctc}$ is a common refinement of local cylinder covers and sparse monomial sign-polynomial certificates, although affine-free sparsity can still be sharper for dense affine threshold pieces.

The dense-affine caveat is now captured by a stronger invariant. The affine-cylinder threshold cost $\operatorname{actc}(f)$ allows one arbitrary affine part at cost one when its linear part is nonzero, then pays the same local cylinder cost for the remaining strict signed cylinder vote:
...
For nonconstant functions with $\deg_{\pm}(f)\leq d$, this recovers the affine-free degree bound through $\operatorname{actc}$:
...
$$
\deg_{\pm}\!\left(\left(\bigoplus_{j=1}^{k}z_j\right)\oplus T(y)\right)
=
k+\deg_{\pm}(T).
$$
...
Affine level sets are now uniformly controlled: every predicate of the form $\mathbf{1}[L(x)=0]$ for affine $L$ has $H^{*}\leq2$, and its exact value is $0$, $1$, or $2$ according as it is constant, a nonconstant LTF, or neither. This recovers internal exact-count predicates and binary-encoded equality as special cases.
...
For any function of one affine statistic $G(L(x))$, the ordered sign-change count of $G$ gives an orientation-free upper bound. Zero, one, and two changes are exactly handled by constants, LTFs, and affine slabs; three or more changes have the explicit bound $1+\sum_{r=2}^{\min\{C,k\}}\binom{k}{r}$, where $k$ is the support size of $L$.
...
Between positive-projection structure and raw sparse support sits the positive run-count invariant $R_{+}(f)$. It gives $H^{*}(f)\leq2R_{+}(f)$, recovering sparse support because the number of minority runs is at most the number of minority points, but improving it whenever the minority label class clusters in a positive ordering.

The first nontrivial run-count case is exact: if $R_{+}(f)=1$, then $H^{*}(f)$ is $0$, $1$, or $2$ according as $f$ is constant, a nonconstant LTF, or neither. The reason is that one positive-order run is an affine slab after inserting cutpoints around the run.

There are also reusable lower-bound closure tools. If $f$ has a restriction equal to $k$-bit parity or anti-parity, then $H^{*}(f)\geq k$. Dummy variables do not change $H^{*}$, so every exact classification for $k$ variables automatically applies to $k$-juntas inside larger cubes. More generally, a high-sign-rank communication matrix under any input partition forces enough heads to support a degree-$H$ sign matrix of that rank.

The sign-rank route has a small-dimension ceiling: it cannot certify $H^{*}\geq3$ for any function on at most $13$ input bits. Thus eight-bit questions such as whether $\mathrm{INT}_4$ needs three heads require a different lower-bound mechanism.
...
- affine-parity restrictions certify $H^{*}(f)\geq\pi_{\oplus}(f)$, where $\pi_{\oplus}(f)$ is the largest affine-parity subcube dimension,
- inner-product mod $2$ has the explicit bracket $m\leq H^{*}(\mathrm{IP}_m)\leq2^m-1$,
- equality on two $m$-bit strings is fully exact: $\deg_{\pm}(\mathrm{EQ}_m)=H^{*}(\mathrm{EQ}_m)=2$ and $s_{\mathrm{LTF}}(\mathrm{EQ}_m)=2$,
...
- affine-statistic predicates $G(L(x))$ have an orientation-free sign-change upper bound $H^{*}\leq1+\sum_{r=2}^{\min\{C,k\}}\binom{k}{r}$ for $C\geq3$, with exact handling for $C\leq2$,
...
- intersection-profile predicates $F(\sum_i x_i y_i)$ have the explicit bracket $C(F)\leq H^{*}\leq\sum_{r=1}^{C(F)}\binom{m}{r}$,
- Hamming-distance profile predicates $F(\Delta(x,y))$ have the explicit bracket $C(F)\leq H^{*}\leq U_m(C(F))$, with $2\leq H^{*}(\mathrm{HDTH}_{m,t})\leq m+1$ for distance thresholds when $m\geq2$,
- directed-defect profile predicates $F(\sum_i x_i(1-y_i))$ have the explicit bracket $C(F)\leq H^{*}\leq V_m(C(F))$, with $2\leq H^{*}(\mathrm{SUB}_m)\leq m+1$ and $2\leq H^{*}(\mathrm{NCON}_m)\leq m+1$ when $m\geq2$,
- the directed-defect endpoint is exact at $m=2$: $H^{*}(\mathrm{SUB}_2)=H^{*}(\mathrm{NCON}_2)=2$,
- every two-pair local-count profile with one sign change has $H^{*}\leq2$, and is exact at $0$, $1$, or $2$ according as it is constant, an LTF, or neither,
- local-pattern count profile structure gives the generic schema $C(F)\leq H^{*}\leq\Lambda_{p,m}(C(F))$ whenever the local two-bit predicate has a symmetric one-bit slice,
- symmetric threshold structure certifies $H^{*}(f) = 1$,
- symmetric sign-change count gives exact $H^{*}(f)$ for every symmetric $f$,
- positive-projection sign-change structure certifies $H^{*}(f) \leq C_{+}(f)$,
- positive-order minority-run structure certifies $H^{*}(f)\leq2R_{+}(f)$,
...
- polynomial-threshold sparsity certifies $H^{*}(f)\leq\operatorname{ptfsp}(f)$, and affine-free sparsity sharpens this to $H^{*}(f)\leq1+\sum_{r=2}^{d}\binom{n}{r}$ for nonconstant functions with $\deg_{\pm}(f)\leq d$,
- cofactor sparse-polynomial recursion certifies $H^{*}(f)\leq m_0+\lvert\mathcal{A}_0\cup\mathcal{A}_1\rvert+1$ from sparse sign polynomials for the two cofactors,
- affine-free cofactor recursion certifies $H^{*}(f)\leq n$ whenever some split has constant or LTF cofactors, and gives exact two-head control when the two affine cofactor separators differ in at most one slope,
- LTF cofactor slope distance certifies $H^{*}(f)\leq1+t$ when $t$ affine slopes change across a split with LTF cofactors,
- the split LTF slope invariant certifies $H^{*}(f)\leq1+\sigma_{\mathrm{split}}(f)$ after minimizing over split coordinates and affine separator choices,
- the split affine-free support invariant certifies $H^{*}(f)\leq\operatorname{scafs}_{\pm}(f)$ by paying for one base cofactor and the coefficient changes across a split,
- one-bit LTF branching certifies $H^{*}(G(z,T(y)))\leq1+\lvert\operatorname{supp}(L)\rvert$ for every Boolean gate $G$,
- one-bit sparse-PTF branching certifies $H^{*}(G(z,T(y)))\leq1+\ell(P)+2q(P)$, with sharper branch-dependent costs when one slice is constant,
- one-bit non-XOR recursion certifies $H^{*}(G(z,T(y)))\leq H^{*}(T)+1$ for every inner feature $T$ whenever $G$ is neither XOR nor XNOR,
- literal decision lists certify $H^{*}(f)\leq L_{\mathrm{litDL}}(f)$ by iterating the non-XOR recursion one tested literal at a time,
- endpoint decision lists certify $H^{*}(f)\leq L$ for decision lists over positive OR-type tests, positive AND-type tests, and complements of those tests,
- calibrated decision lists certify $H^{*}(f)\leq L$ whenever their test indicators have one-head atom approximations accurate enough for the strict decision-list vote margin,
...
- raw-calibrated votes certify $H^{*}$ upper bounds by summing the raw atom approximation costs $\rho(T_j)$ of their inner features, with $\rho(T)\leq\operatorname{eafs}(T)$ as a concrete exact-polynomial fallback,
- raw-calibrated decision lists certify $H^{*}(f)\leq\sum_j\rho(T_j)\leq\sum_j\operatorname{eafs}(T_j)$ for tests $T_j$,
- threshold degree lower-bounds raw calibration cost in strict votes: $\deg_{\pm}(f)\leq\sum_j\rho(T_j)$,
- subcube tests satisfy $\rho(C_{P,N})\leq\min\{2^{\lvert P\rvert},2^{\lvert N\rvert}\}$, with cost $0$ for the vacuous cylinder,
...
- strict threshold votes over subcube indicators certify $H^{*}$ upper bounds by summing the local costs $\kappa(P,N)$,
- the optimized cylinder-threshold cost $\operatorname{ctc}(f)$ is a finite direct upper-bound invariant for every Boolean function,
- $\operatorname{ctc}$ is invariant under complements, coordinate permutations, global bit-flips, and dummy variables, and it is monotone under restrictions,
- $\operatorname{ctc}$ subsumes one-sided local certificate covers, mixed-literal DNF/CNF local expansion, and decision-tree leaf-profile costs,
- $\operatorname{ctc}(f)\leq\operatorname{ptfsp}(f)$, so sparse PTF upper bounds factor through the cylinder-threshold invariant,
- affine-cylinder threshold cost certifies $H^{*}(f)\leq\operatorname{actc}(f)\leq\operatorname{ctc}(f)$ by allowing one dense affine component at cost one,
- $\operatorname{actc}(f)\leq\operatorname{afs}_{\pm}(f)\leq\operatorname{ptfsp}(f)$, so affine-free sparse PTF bounds also factor through the affine-cylinder invariant,
- intersections of two halfspaces can have $H^{*}(f)\geq c n$, by threshold-degree lower bounds,
- threshold-vote size and LTF decision-list length can both be at most $2$ while $H^{*}$ grows linearly,
- one-head computable LTFs can have raw calibration cost $\rho(T)\geq c n$,
- $\operatorname{actc}$ is invariant under complements, coordinate permutations, global bit-flips, and dummy variables, and it is monotone under restrictions,
- functions with $\operatorname{actc}(f)\leq2$ have exact value $0$, $1$, or $2$ according as they are constant, nonconstant LTFs, or neither,
- threshold degree lower-bounds $\operatorname{actc}$, $\operatorname{ctc}$, $\operatorname{afs}_{\pm}$, and $\operatorname{ptfsp}$ through the head-complexity sandwich,
- affine-cylinder cofactor interpolation certifies $\operatorname{actc}$ upper bounds by paying only for base cylinder supports and changed affine or cylinder coefficients across a split,
- fresh-bit XOR certifies $\deg_{\pm}(z\oplus f)=\deg_{\pm}(f)+1$ and hence $H^{*}(z\oplus f)\geq\deg_{\pm}(f)+1$,
...
- parity-block restrictions certify $H^{*}(f)\geq k+\deg_{\pm}(T)$ whenever a restriction equals a parity block XOR a residual feature $T$,
- calibrated threshold-vote certificates prove $H^{*}\leq s$ when $s$ one-head atoms approximate the inner vote features within the outer vote margin,
- endpoint affine-threshold votes certify $H^{*}\leq s$ for strict weighted votes over positive OR-type and AND-type features,
...
- monotone normal-form structure certifies $H^{*}(f)\leq\min\{\operatorname{mDNF}(f),\operatorname{mCNF}(f)\}$,
- monotone boundary structure certifies $H^{*}(f)\leq\binom{n}{\lfloor n/2\rfloor}$ for every monotone $f$,
...
- sparse-support structure certifies $H^{*}(f)\leq2\min\{\lvert f^{-1}(1)\rvert,\lvert f^{-1}(0)\rvert\}$,
- mixed-literal formula volume certifies $H^{*}(f)\leq2\sum_a2^{n-w_a}$ for DNF or CNF widths $w_a$,
- mixed-literal formula literal imbalance certifies $H^{*}(f)\leq\sum_a\min\{2^{\lvert P_a\rvert},2^{\lvert N_a\rvert}\}$ for DNF or CNF normal forms,
- mixed-literal formulas also certify the hybrid used-variable bound $\min\{2\sum_a2^{v-w_a},\sum_a\min\{2^{\lvert P_a\rvert},2^{\lvert N_a\rvert}\},2^v-1,1+\sum_{r=2}^{\min\{w,v\}}\binom{v}{r}\}$,
- decision-tree leaf profiles certify ambient-dimension-free upper bounds, in particular $H^{*}(f)\leq2^{D(f)+\lfloor D(f)/2\rfloor-1}$ for nonconstant $f$,
- depth-two decision trees have exact value $0$, $1$, or $2$ according as the function is constant, a nonconstant LTF, or neither,
- decision trees also certify the hybrid bound $H^{*}(f)\leq\min\{\Lambda(\mathcal{T}),2^v-1,1+\sum_{r=2}^{\min\{d,v\}}\binom{v}{r}\}$, where $d$ is tree depth and $v$ is the number of queried variables,
- local certificate-expansion structure certifies $H^{*}(f)$ from one-sided certificate covers whose cylinders each fix few bits of at least one sign,
- junta structure certifies ambient-dimension-free bounds depending only on $\operatorname{ess}(f)$,
- certificate-cover structure certifies upper bounds from one-sided weighted subcube covers,
- three-bit quadratic threshold structure certifies $H^{*}(f) \leq 2$,
- three-bit arbitrary threshold structure certifies $H^{*}(f) \leq 3$, closing the full $n=3$ classification,
- three-bit threshold-vote structure certifies $s_{\mathrm{LTF}}(f)=H^{*}(f)=\deg_{\pm}(f)$ for every three-bit Boolean function,
- four-bit arbitrary threshold structure certifies $H^{*}(f) \leq 4$,
- five-bit arbitrary threshold structure certifies $H^{*}(f) \leq 7$,
- six-bit arbitrary threshold structure certifies $H^{*}(f) \leq 11$,
- seven-bit arbitrary threshold structure certifies $H^{*}(f) \leq 19$,
- eight-bit arbitrary threshold structure certifies $H^{*}(f) \leq 32$,
- nine-bit arbitrary threshold structure certifies $H^{*}(f) \leq 57$,
- ten-bit arbitrary threshold structure certifies $H^{*}(f) \leq 103$,
- eleven-bit arbitrary threshold structure certifies $H^{*}(f) \leq 187$,
- twelve-bit arbitrary threshold structure certifies $H^{*}(f) \leq 342$,
